<?php
/* Smarty version 3.1.29, created on 2018-02-08 05:49:51
  from "/Users/admin/Desktop/sihalive/application/views/ShopCart/shop-cart.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a7bd6efc95443_78188451',
  'file_dependency' => 
  array (
    'a62120bdf88b79008ace5d9044d918fb73281219' => 
    array (
      0 => '/Users/admin/Desktop/sihalive/application/views/ShopCart/shop-cart.tpl',
      1 => 1518065391,
      2 => 'file',
    ),
  ),
...
function content_5a7bd6efc95443_78188451 ($_smarty_tpl) {
?>
<!-- Page Content-->
...
<section class="section-50 section-sm-100">
	<div class="container">
		...
		<div  class="row grid-system-row offset-top-50 ">
			<div class="shell">
				<h5><?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_info'];?>
</h5>
						...
						<form method="post"  class="rd-mailform form-contact-line text-left " >
							...
							<div class="form-inline-flex">
								<div class="form-group">
									<label for="o_consignee" class="form-label form-label-outside rd-input-label"><?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_consignee'];?>
</label>
									<input id="o_consignee" type="text"  ng-model="data.o_consignee" placeholder="<?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_consignee'];?>
" name="o_consignee" data-constraints="@Required" class="form-control form-control-has-validation form-control-last-child input-lg">
									<span class="form-validation"></span>
								</div>
								<div class="form-group">
									<label for="o_phone" class="form-label form-label-outside rd-input-label"><?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_phone'];?>
</label>
									<input id="o_phone" type="text" ng-model="data.o_phone" placeholder="<?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_phone'];?>
" name="o_phone" data-constraints="@Required" class="form-control form-control-has-validation form-control-last-child input-lg">
									<span class="form-validation"></span>
								</div>
							</div>
							<div class="form-inline-flex">
								<div class="form-group">
									<label for="message" class="form-label form-label-outside rd-input-label"><?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_position'];?>
</label>
								...
								<div class="form-group ">
									<label for="message" class="form-label form-label-outside rd-input-label"><?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_message'];?>
</label>
									<input type="text"  id="message" placeholder="<?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_message_placeholder'];?>
" name="o_messge"  class="form-control form-control-has-validation form-control-last-child input-lg">
									<span class="form-validation"></span>
								</div>
										...
										<div class="form-group offset-top-0" style="margin-top: -5px; width: 90%">
											<div class="form-inline-flex">
												...
												<div class="form-group ">
													...
													<input type="text"  id="message" placeholder="<?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_delivery_message_placeholder'];?>
" name="o_messge"  class="form-control form-control-has-validation form-control-last-child input-sm">
													<span class="form-validation"></span>
												</div>
												<div class="form-group ">
							...
							<div class="offset-top-15">
								<div class="form-inline-flex">
									<div class="form-group">
										<button ng-click="checkout();$event.preventDefault();"  class="btn btn-primary btn-fullwidth"><?php echo $_smarty_tpl->tpl_vars['shopLanguageAry']->value['shopcart_proceed_to_checkout'];?>
</button>
									</div>
								</div>
							</div>
